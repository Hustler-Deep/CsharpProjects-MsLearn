...
```
## Exercise - Check if IP address is valid
...
// The first rule states that the IPv4 address needs to have four numbers
void ValidateLength() {
    validLength = address.Length == 4;
}

// The second rule states that the numbers in the IPv4 address must not contain leading zeroes
void ValidateZeroes() {
...
// The third rule states that each number in the IPv4 address must range from 0 to 255
void ValidateRange() {
